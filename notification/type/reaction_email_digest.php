 ...
 * 
 * Rôle :
 * Définit le type de notification "Résumé e-mail des réactions". Cette classe est utilisée
 * exclusivement par la tâche CRON (`cron/notification_task.php`) pour envoyer un e-mail
 * récapitulatif (digest) des réactions reçues.
 * 
 * Ce type est utilisé exclusivement par la tâche cron afin d'envoyer un digest périodique des
 * réactions reçues. Aucune entrée n'est créée dans la cloche phpBB. Contrairement à `reaction.php`,
 * ce type ne crée pas de notification visible
