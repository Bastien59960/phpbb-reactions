 ...
 * Contrairement à `reaction.php`, ce type ne crée pas de notification visible dans la
 * cloche. Il sert uniquement de "véhicule" pour envoyer un e-mail formaté avec un
 * template spécifique (`reaction_digest.txt`).
 *
