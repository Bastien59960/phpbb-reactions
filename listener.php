<?php
/**
 * Fichier : listener.php
 * Chemin : bastien59960/reactions/event/listener.php
 *
 * Rôle :
 * Listener d'événements pour l'extension Reactions.
 * Ce fichier intercepte les événements du cœur de phpBB pour injecter les
 * fonctionnalités de l'extension, comme l'affichage des réactions sous les
 * messages, l'ajout des assets (CSS/JS) et le chargement des fichiers de langue.
 *
