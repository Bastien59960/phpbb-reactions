 ...
 *
 * Description:
 * English language strings for the Administration Control Panel (ACP) of the
 * Reactions extension.
 *
 * (c) 2025 Bastien59960 — GNU GPL v2.
 */
...
$lang = array_merge($lang ?? [], [
    ...
    'REACTIONS_PICKER_EMOJI_SIZE_EXPLAIN'=> 'Controls the size (in pixels) of the picker emojis and the category/tab icons.',
