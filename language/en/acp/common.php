...
$lang = array_merge($lang ?? [], [
    ...
    'REACTIONS_SPAM_TIME_EXPLAIN'        => 'Minimum delay (in minutes) before sending another email summary to the same user.',
    ...
    'REACTIONS_PICKER_SHOW_CATEGORIES_EXPLAIN' => 'Uncheck to hide the category tabs and only show frequent emojis.',
    ...
    'REACTIONS_PICKER_USE_JSON'          => 'Load the full emoji set',
    'REACTIONS_PICKER_USE_JSON_EXPLAIN'  => 'Uncheck to not load the external JSON file and only show the 10 frequent emojis.',
    ...
    'LOG_REACTIONS_IMPORT_EMPTY'         => '<strong>Reactions import skipped</strong><br>• Old tables were found but were empty.',
    'LOG_REACTIONS_IMPORT_SUCCESS'       => '<strong>Reactions import complete</strong><br>• %1$d reactions imported (%2$d skipped).<br>• %3$d users and %4$d posts affected.',
]);