 ...
 *
 * Rôle :
 * Ce fichier gère toute l'interactivité côté client pour les réactions. Il est
 * responsable de l'affichage du sélecteur d'emojis, de l'envoi des requêtes
 * AJAX pour ajouter/supprimer des réactions, et de la mise à jour dynamique
 * de l'interface sans rechargement de page.
 *
